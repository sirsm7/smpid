 ...
 * Update: Added /notify-booking endpoint without reducing existing code.
 */
...
Deno.serve(async (req) => {
  ...
  // --- [6] ENDPOINT: /notify-booking (Tempahan Bimbingan Baru) ---
  ...
  // --- [7] FALLBACK KE TELEGRAM BOT WEBHOOK ---
